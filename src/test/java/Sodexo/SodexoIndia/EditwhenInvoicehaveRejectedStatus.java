...
public class EditwhenInvoicehaveRejectedStatus {
	 public	WebDriver driver;
	 @Parameters({ "username", "password",  "URL"})
  @Test
  public void EditfunctionalityonRejectedcase(String username, String password, String URL) throws InterruptedException {
			...
			driver=new ChromeDriver();
				Reporter.log("Edit the Invoice details when Invoice have rejected status");
			...
			// driver=new FirefoxDriver();
				...
				optionsinstatus.selectByVisibleText("Rejected");
			...
			//	innertext.click();
				...
				WebElement buyername=driver.findElement(By.xpath("(//input[contains(@class,'form-control')])[4]"));
				buyername.clear();
				...
				WebElement supplierno=driver.findElement(By.xpath("(//input[contains(@class,'form-control')])[7]"));
				//js. executeScript("arguments[0]. scrollIntoView(true);", supplierno);
				//Thread.sleep(1000);
				supplierno.clear();
				supplierno.sendKeys("VMD918988");
				Thread.sleep(3000);
  ...
  public void beforeMethod() {
	  System.out.println("Edit the Invoice details when Invoice have rejected status");
  }
